...
export const fetchLeaderboardData = async (options = {}) => {
  ...
  if (filterFavorites !== undefined) {
    params.filterFavorites =
      filterFavorites === "true" || filterFavorites === true;
  }
